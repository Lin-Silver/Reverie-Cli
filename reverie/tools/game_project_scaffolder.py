    ...
    def _generate_vertical_slice(self, output_dir: Path, request_path: Path, kwargs: Dict[str, Any]) -> ToolResult:
        ...
        return ToolResult.ok(
            output,
            {
                ...
                "design_intelligence": result.get("design_intelligence", {}),
                "campaign_program": result.get("campaign_program", {}),
                "roster_strategy": result.get("roster_strategy", {}),
                "live_ops_plan": result.get("live_ops_plan", {}),
                "production_operating_model": result.get("production_operating_model", {}),
                "expansion_backlog": result.get("expansion_backlog", {}),
                "resume_state": result.get("resume_state", {}),
                "production_directive": result.get("production_directive", {}),
