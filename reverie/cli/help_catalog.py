...
HELP_TOPICS: Dict[str, Dict[str, object]] = {
    ...
    "modeling": {
        "command": "/modeling",
        "section": "Game",
        "summary": "Run the Reverie-Gamer-only built-in modeling workflow, including workspace setup, model import, registry sync, and Ashfox MCP calls.",
        "detail": "This command is exclusive to `reverie-gamer` mode. It standardizes Blockbench source files under `assets/models/source`, runtime imports under `assets/models/runtime`, generated registries under `data/models`, and Ashfox MCP operations against Reverie's built-in `ashfox` server entry. The only manual external installs are Blockbench desktop and the Ashfox plugin.",
        "overview": "status, setup, sync, stub, import, ashfox tools|capabilities|state|validate|export|call",
        "subcommands": [
        ...
        "examples": ["/modeling", "/modeling setup", "/modeling stub hero_body", "/modeling import exports/hero.glb assets/models/source/hero_body.bbmodel", "/modeling ashfox tools", "/modeling ashfox validate", "/modeling ashfox export gltf assets/models/runtime/hero.glb"],
    },
    "playtest": {
        "command": "/playtest",
        "section": "Game",
