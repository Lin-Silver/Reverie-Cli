...
HELP_TOPICS: Dict[str, Dict[str, object]] = {
    ...
    "skills": {
        ...
        "detail": "Reverie scans compatibility roots under `.reverie/Skills`, `.reverie/skills`, and `.codex/skills`, including nested repository layouts like `<repo>/skills/<skill>/SKILL.md`. Detected skills are exposed in `/skills`, described in the system prompt, and can be activated explicitly with `$skill-name` or auto-selected when the request clearly matches a skill.",
        ...
        "subcommands": [
            ...
            {"usage": "/skills rescan", "description": "Rescan compatibility roots and refresh prompt guidance."},
