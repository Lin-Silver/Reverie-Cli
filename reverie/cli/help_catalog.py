...
HELP_TOPICS: Dict[str, Dict[str, object]] = {
    "help": {
        "command": "/help",
        "section": "Core",
        "summary": "Browse the live help catalog, pin a detailed page, or print static help panels.",
        "detail": "Bare `/help` opens the interactive browser. Press Enter or Esc to pin the current command panel into the transcript; `/help list` prints the grouped index and `/help all` prints every detailed panel.",
        "overview": "browser, list/overview/index, all, <command>",
        "subcommands": [
            {"usage": "/help", "description": "Open the interactive help browser with live navigation, filtering, and detailed command pages."},
            {"usage": "/help ui", "description": "Explicitly open the interactive help browser.", "example": "/help ui"},
            {"usage": "/help ui <query>", "description": "Open the browser with an initial filter applied.", "example": "/help ui iflow model"},
            {"usage": "/help list", "description": "Print the grouped command index as static output.", "example": "/help list"},
            {"usage": "/help overview", "description": "Alias of `/help list`.", "example": "/help overview"},
            {"usage": "/help index", "description": "Alias of `/help list`.", "example": "/help index"},
            {"usage": "/help <command>", "description": "Show detailed help for a single command such as `/help codex` or `/help CE`."},
            {"usage": "/help all", "description": "Print the detailed help view for every command in sequence."},
        ],
        "examples": ["/help", "/help ui iflow", "/help codex", "/help iflow model", "/help all"],
    },
    "status": {
        "command": "/status",
        "section": "Core",
    ...
    "add_model": {
        "command": "/add_model",
        "section": "Models & Modes",
        "summary": "Direct entry point for the interactive standard-model creation flow.",
        "detail": "Equivalent to `/model add`; kept for compatibility and direct invocation.",
        "overview": "interactive add",
        "aliases": ["/model add"],
        "subcommands": [
            {"usage": "/add_model", "description": "Start the interactive add-model wizard for endpoint, key, model id, and display name."},
            {"usage": "/model add", "description": "Preferred alias that routes to the same flow."},
        ],
        "examples": ["/add_model", "/model add"],
    },
    "mode": {
        "command": "/mode",
        "section": "Models & Modes",
    ...
    "qwencode": {
        ...
        "overview": "status/check, login, model [id], endpoint [value]",
        "subcommands": [
            ...
            {"usage": "/qwencode check", "description": "Alias of `/qwencode status`."},
    ...
    "geminicli": {
        "command": "/Geminicli",
        "section": "Providers",
        "summary": "Manage Gemini CLI OAuth relay status, models, project id, and endpoint override.",
        "detail": "This provider uses Gemini CLI credentials and can also store a project id for requests that need one.",
        "overview": "status/check, login, model [id], project [id], endpoint [value]",
        "aliases": ["/geminicli"],
        "subcommands": [
            {"usage": "/Geminicli", "description": "Show Gemini CLI credential, model, and project-id status."},
            {"usage": "/Geminicli status", "description": "Explicit status view."},
            {"usage": "/Geminicli check", "description": "Alias of `/Geminicli status`."},
            ...
            {"usage": "/Geminicli project", "description": "Show the current project id and prompt for a new one."},
            {"usage": "/Geminicli project <project-id|clear>", "description": "Set or clear the stored Gemini project id."},
        ...
        "examples": ["/Geminicli", "/Geminicli project my-gcp-project", "/Geminicli model gemini-2.5-pro"],
    },
    "codex": {
        "command": "/codex",
        "section": "Providers",
        "summary": "Manage Codex relay status, models, endpoint override, and four-level reasoning depth.",
        "detail": "Reverie keeps the model id stable and applies the selected reasoning depth automatically in the Codex request payload.",
        "overview": "status/check, login, model [id], thinking/reasoning [level], endpoint [value], low|medium|high|extra high",
        "subcommands": [
            {"usage": "/codex", "description": "Show Codex credential, model, endpoint, and reasoning-depth status."},
            {"usage": "/codex status", "description": "Explicit status view."},
            {"usage": "/codex check", "description": "Alias of `/codex status`."},
            {"usage": "/codex login", "description": "Validate or refresh Codex credentials from the local CLI cache."},
            {"usage": "/codex model", "description": "Open the Codex model selector."},
            {"usage": "/codex model <model-id>", "description": "Switch directly to a supported Codex model."},
            ...
            {"usage": "/codex reasoning <low|medium|high|extra high>", "description": "Alias of `/codex thinking <level>`."},
        ...
        "examples": ["/codex", "/codex model gpt-5.4", "/codex thinking", "/codex extra high"],
    },
    "tools": {
        "command": "/tools",
