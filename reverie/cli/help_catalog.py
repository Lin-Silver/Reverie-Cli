...
HELP_TOPICS: Dict[str, Dict[str, object]] = {
    ...
    "web": {
        "command": "/web",
        "section": "Providers",
        "summary": "Manage the direct browser-backed Web source, including chat-model selection, image-model selection, browser/session settings, and the Web settings TUI.",
        "detail": "This source now routes chat models directly through browser-backed site adapters instead of relying on a localhost relay. Bare `/web` shows status. `/web model` picks the active Web chat model, while `/web image-model` picks the default Web image model used when `/tti source web` is active.",
        "overview": "status, activate, model [id], image-model [id], start, stop, endpoint [value], port [value], auth [token], settings",
        "subcommands": [
            {"usage": "/web", "description": "Show the current Web source status, selected models, and browser/runtime paths."},
            {"usage": "/web status", "description": "Explicit status view."},
            {"usage": "/web activate", "description": "Switch the active model source to Web using the stored Web chat model."},
            {"usage": "/web model", "description": "Open the Web chat-model selector."},
            {"usage": "/web model <model-id>", "description": "Switch directly to a Web chat model by id or fuzzy match."},
            {"usage": "/web image-model", "description": "Open the Web image-model selector used by `/tti source web`."},
            {"usage": "/web image-model <model-id>", "description": "Switch directly to a Web image model by id or fuzzy match."},
            {"usage": "/web start", "description": "Warm the browser-backed Web runtime for diagnostics or session validation."},
            {"usage": "/web stop", "description": "Release the browser-backed Web runtime."},
            {"usage": "/web endpoint <url|/path|clear>", "description": "Legacy relay override. Chat direct mode usually does not need this."},
            {"usage": "/web port <port>", "description": "Legacy relay port override kept for compatibility with existing image flows."},
            {"usage": "/web auth <token>", "description": "Legacy relay auth token override kept for compatibility with existing image flows."},
            {"usage": "/web settings", "description": "Open the interactive Web settings TUI.", "example": "/web settings"},
        ],
        "examples": ["/web", "/web activate", "/web model", "/web image-model", "/web start", "/web settings"],
    },
    "tools": {
        "command": "/tools",
    ...
    "tti": {
        "command": "/tti",
        "section": "Tools & Context",
        "summary": "Generate images from either local configured models or the Web-backed image catalog, and switch sources from one command namespace.",
        "detail": "Bare `/tti` needs a child action or prompt. `/tti source` switches between `local` and `web`. Local model entries still live in `text_to_image.models`, while the Web image-model list comes from the bundled WebAI2API catalog.",
        "overview": "models, source [local|web], add, <prompt>",
        "subcommands": [
            {"usage": "/tti models", "description": "Open the selector for the active TTI source and change the default image model."},
            {"usage": "/tti source", "description": "Prompt for the active TTI source (`local` or `web`)."},
            {"usage": "/tti source <local|web>", "description": "Switch the active TTI source directly."},
        ...
        "examples": ["/tti source web", "/tti models", "/tti add", "/tti cyberpunk rainy alley concept art"],
    },
    "setting": {
        "command": "/setting",
