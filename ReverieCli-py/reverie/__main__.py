...
def _exit_prompt_mode(exit_code: int) -> int:
    """Exit one-shot prompt mode, forcing packaged Windows builds to release promptly."""
...
def main(argv: list[str] | None = None):
    ...
    if args.index_only:
        ...
        return _exit_prompt_mode(0 if result.success else 1)
