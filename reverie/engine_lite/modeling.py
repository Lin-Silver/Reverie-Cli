...
def detect_modeling_stack(project_root: str | Path) -> Dict[str, Any]:
    ...
    return {
        "mode": "reverie-gamer",
        "integration": "built_in_ashfox_mcp",
        "blockbench": {
            **blockbench,
        ...
        "ashfox": {
            ...
            "manual_dependency": True,
            "install_hint": "Install the Ashfox plugin inside Blockbench, launch Blockbench, and keep the local MCP endpoint running while using live model-authoring tools.",
        },
    }
...
def build_model_pipeline_manifest(project_root: str | Path) -> Dict[str, Any]:
    ...
    return {
        ...
        "workflow": {
            ...
            "preferred_editor": "Blockbench",
            "automation_mcp": "Ashfox MCP",
        ...
        "stack": stack,
        "notes": [
            "Reverie ships the modeling workflow directly in Reverie-Gamer instead of depending on checked-out Blockbench or Ashfox source trees.",
            "Only Blockbench desktop and the Ashfox plugin remain external manual installs for live authoring and MCP automation.",
...
def build_modeling_project_doc() -> str:
    return (
        ...
        "- Keep Blockbench running when using live Ashfox MCP tools through Reverie-Gamer.\n\n"
