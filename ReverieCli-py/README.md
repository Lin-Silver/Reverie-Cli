...
- **RATS / RTP** - executable-local allowlisted provider discovery, opt-in permission sessions, and progressively loaded native provider tools owned by the Python core; Reverie Engine is currently the only implemented provider
