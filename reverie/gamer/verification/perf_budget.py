    ...
    *,
    ...
    return {
        ...
        "budgets": {
            ...
            "streamed_regions": streamed_regions,
        ...
        "subsystem_budgets": {
            "world_streaming": {
                "active_regions": streamed_regions,
                "active_cells": streaming_cells,
                "transition_budget_seconds": 4.0 if world_structure in {"open_world_regions", "hub_and_districts"} else 2.0,
            },
            "combat": {
                "active_ai_agents": active_ai_agents,
                "projectiles": 12 if dimension == "3D" else 24,
